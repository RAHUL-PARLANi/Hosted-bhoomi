...
const BoardGame = (props) => (
    <tr>
                <td className="text-xs font-weight-bold"><button className="edit-button"><Link style={{color:'inherit',textDecoration:"none"}} to={"/admin/editfls/"+props.bg._id} ><FontAwesomeIcon icon="fa-solid fa-pen" /> Edit</Link></button>  <button className="delete-button" onClick={() => {props.deleteBGS(props.bg._id) }}><FontAwesomeIcon icon="fa-solid fa-trash" /> Delete</button></td>
...
class ShowFLS extends Component {
...
deleteBGS(id) {
            axios.delete('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/fl/' +id)
  ...
  <div className='Title-homepage-Table'>Flood Light Products</div>
