...
const Homepage = () => {
  ...
  return (
    <>
          <Navbar/>
        <form className='Service-from' id='form-closed' onSubmit={handleSubmit} >
            <div style={{
    ...
    <div className='heading2'>TOP THREE FLOOD LIGHTS</div>
    <Bestsellers title={'FLOOD LIGHTS'} />
    <div className='heading2'>TOP THREE CONCEALED LIGHTS</div>
    <Bestsellers title={'CONCEALED LIGHTS'} />
    <div className='heading2'>TOP THREE PANEL LIGHTS</div>
    <Bestsellers title={'PANEL LIGHTS'} />
    <div className='heading2'>TOP THREE STREET LIGHTS</div>
    <Bestsellers title={'STREET LIGHTS'}/>
    <div className='heading2'>TOP THREE WALL LIGHTS</div>
    ...
    <div className='shopbycategory'>
        ...
        <div className='all-p1'>
            <Link to="/floodlights/" style={{'textDecoration':'inherit','color':'inherit'}}><div className='card2'>
