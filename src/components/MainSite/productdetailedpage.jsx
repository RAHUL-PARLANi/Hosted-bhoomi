...
function wtp(){
    axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/fl/WTP/'+window.location.pathname.split('/').pop()).then(
        alert('Liked')
    )
...
const FLinfo = () => {
    ...
    useEffect(() => {
        axios.get('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/fl/'+window.location.pathname.split('/').pop())
                    .then(res => {
                    ...
                    <div className='Recommended-Products'>
                        <div className='heading2'>RECOMMENDED PRODUCTS</div>
                            ...
                            data1.filter(el=>{
                                ...
                                <div className='tags'>Weight :</div><div className='tags-details'> {elemet.productWeight}</div>
                                ...
                                <a href={'/floodlight/'+elemet._id}><button className='view-more'>View More</button></a>
                                </div>
