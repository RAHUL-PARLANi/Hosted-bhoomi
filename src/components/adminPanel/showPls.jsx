...
const BoardGame = (props) => (
    <tr>
                <td className="text-xs font-weight-bold"><button className="edit-button"><Link style={{color:'inherit',textDecoration:"none"}} to={"/admin/editpls/"+props.bg._id} ><FontAwesomeIcon icon="fa-solid fa-pen" /> Edit</Link></button>  <button className="delete-button" onClick={() => {props.deleteBGS(props.bg._id) }}><FontAwesomeIcon icon="fa-solid fa-trash" /> Delete</button></td>
               <td className="text-xs font-weight-bold">{props.bg.productProductCode}</td>
               <td className="text-xs font-weight-bold">{props.bg.productType}</td>
               ...
               <td className="text-xs font-weight-bold">{props.bg.productSurfaceRing}</td>
...
class ShowPLS extends Component {
...
deleteBGS(id) {
            axios.delete('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/pl/' +id)
  ...
  <div className='Title-homepage-Table'>Panel Light Products</div>
       ...
       <table id="table" className="table align-items-center justify-content-center mb-0">
           <thead>
               ...
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">TYPE :</th>
               ...
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">CUT OUT :</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">SURFACE RING :</th>
