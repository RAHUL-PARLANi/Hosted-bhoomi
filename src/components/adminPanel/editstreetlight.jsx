...
export function withRouter(Children){
 ...
 class EditSl extends React.Component { 
    ...
    componentDidMount() {
        axios.get('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/sl/'+this.props.match.params.id)
            .then(res => {
                this.setState({
                   ...
                   productPolDia:res.data.productPolDia,
    ...
    onSubmit(e) {
        ...
        axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/sl/update/'+this.props.match.params.id, exercise).then(res=>{this.setState({message:res})})
        ...
        return (
            ...
            <div className="admin-form-container">
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="admin-form-box">
                        <label><FontAwesomeIcon icon="fa-solid fa-play" /> POL DIA: </label>
                        <input
                            type="text" 
                            className="admin-form-input"
...
export default withRouter(EditSl);