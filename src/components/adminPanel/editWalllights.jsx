...
export function withRouter(Children){
 ...
 class EditWl extends React.Component { 
    ...
    componentDidMount() {
        axios.get('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/wl/'+this.props.match.params.id)
            .then(res => {
                this.setState({
                    ...
                    productColourAvailable:res.data.productAvailable,
    ...
    onSubmit(e) {
        ...
        const exercise = {
            ...
            productColourAvailable:this.state.productAvailable,
        ...
        axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/wl/update/'+this.props.match.params.id, exercise).then(res=>{this.setState({message:res})})
    ...
    render() { 
        ...
        <div className="admin-form-container">
            <div className='Title-homepage'>Edit this Wall Light Product</div>
...
export default withRouter(EditWl);