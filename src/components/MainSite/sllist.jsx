    ...
    <div className='Listproducts'>
      <div className='productfilter'>
        <div className='Sorter' style={{'display':'flex'}}>
            ...
            <div id='filteroperner' style={{'display':'none'}}><div style={{'color':'#d92126','borderBottom':'2px solid #d92126'}}><div className='same1 tags-details'>BY A TO Z</div></div>
            <div style={{'color':'#d92126','borderBottom':'2px solid #d92126'}}><div className='same1 tags-details'>BY Z TO A</div></div>
            <div style={{'color':'#d92126','borderBottom':'2px solid #d92126'}}><div className='same1 tags-details'>BY PRICE</div></div>
            <div style={{'color':'#d92126','borderBottom':'2px solid #d92126'}}><div className='same1 tags-details'>BY MOST POPULAR</div></div>
            <div style={{'color':'#d92126','borderBottom':'2px solid #d92126'}}><div className='same1 tags-details'>BY LATEST</div>
            </div>
        ...
        <div className='Sorter' style={{'display':'flex'}}>
            ...
            {this.props.category.map(element=>{
              return   <div style={{'color':'#d92126','borderBottom':'2px solid #d92126'}}><div className='same1 tags-details'>{element}</div></div>
            })}
...
import streetlights from './../../images/Screenshot (291).png'
...
Namedec(){
  ...
  <Helmet>
    ...
    <Navbar/>
    <div className='Listproducts'>
     <img src={streetlights} height='400px'/>
      <div className='productfilter'>
        <div className='Sorter' style={{'display':'flex'}}>
            <div  className='same tags'>SORT : </div>
            <div className='select' style={{'position':'absolute','color':'#d92126'}}>
