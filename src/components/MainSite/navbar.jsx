  ...
  return (
    <div className='NavBar-main'>
       ...
       <div className='Navbar-logo'>
        <div style={{'display':'flex','alignItems':'center'}}><div id='relo' onClick={()=>{open()}} style={{'border':'3px solid black','fontSize':'32px','width':'40px','height':'45px','color':"black",'marginLeft':'5px','textAlign':'center','borderRadius':'5px'}}><FontAwesomeIcon icon="fa-solid fa-bars" /></div><Link to='/'><img src={logo} alt="logo"/></Link></div>
