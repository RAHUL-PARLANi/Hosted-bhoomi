...
const BoardGame = (props) => (
    <tr>
                <td className="text-xs font-weight-bold"><button className="edit-button"><Link style={{color:'inherit',textDecoration:"none"}} to={"/admin/editsls/"+props.bg._id} ><FontAwesomeIcon icon="fa-solid fa-pen" /> Edit</Link></button>  <button className="delete-button" onClick={() => {props.deleteBGS(props.bg._id) }}><FontAwesomeIcon icon="fa-solid fa-trash" /> Delete</button></td>
               <td className="text-xs font-weight-bold">{props.bg.productModelNo}</td>
               <td className="text-xs font-weight-bold">{props.bg.productWatt}</td>
               <td className="text-xs font-weight-bold">{props.bg.productWeight}</td>
               ...
               <td className="text-xs font-weight-bold">{props.bg.productPolDia}</td>
...
class ShowSLS extends Component {
...
deleteBGS(id) {
            axios.delete('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/sl/' +id)
  ...
  <div className='Title-homepage-Table'>Street Light Products</div>
         <div class="table-responsive">
       <table id="table" className="table align-items-center justify-content-center mb-0">
           <thead>
               <tr>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">ACTIONS:</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">MODEL NUMBER :</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">WATT :</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">WEIGHT :</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">LENGHT :</th>
               ...
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">POL DIA :</th>
