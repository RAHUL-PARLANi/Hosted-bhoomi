...
const BoardGame = (props) => (
    <tr>
                <td className="text-xs font-weight-bold"><button className="edit-button"><Link style={{color:'inherit',textDecoration:"none"}} to={"/admin/editwls/"+props.bg._id} ><FontAwesomeIcon icon="fa-solid fa-pen" /> Edit</Link></button>  <button className="delete-button" onClick={() => {props.deleteBGS(props.bg._id) }}><FontAwesomeIcon icon="fa-solid fa-trash" /> Delete</button></td>
               ...
               <td className="text-xs font-weight-bold">{props.bg.productColourAvailable}</td>
...
class ShowWLS extends Component {
...
deleteBGS(id) {
            axios.delete('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/wl/' +id)
  ...
  <div className='Title-homepage-Table'>Wall Light Products</div>
       ...
       <table id="table" className="table align-items-center justify-content-center mb-0">
           <thead>
               ...
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">COLOUR AVAILABLE :</th>
