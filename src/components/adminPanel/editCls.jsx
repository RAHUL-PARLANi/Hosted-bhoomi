...
export function withRouter(Children){
 ...
 class DetailsPage extends React.Component { 
    ...
    componentDidMount() {
        axios.get('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/cl/'+this.props.match.params.id)
            .then(res => {
                this.setState({
                    ...
                    productColourAvailable:res.data.productColourAvailable,
    ...
    onSubmit(e) {
        ...
        axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/cl/update/'+this.props.match.params.id, exercise).then(res=>{this.setState({message:res.data})})
    ...
    render() { 
        return (
            ...
            <div className="admin-form-container">
                <div className='Title-homepage'>Edit this Concealed Light Product</div>
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="admin-form-box">
                        <label className="admin-form-label" ><FontAwesomeIcon icon="fa-solid fa-play" /> MODEL:</label>
                        <input
                            type="text" 
                            className="admin-form-input"
                    ...
                    <div className='admin-form-box' >
                        <button type="submit" value="Edit" className="Submit-Button"><FontAwesomeIcon icon="fa-solid fa-circle-plus" /> Edit</button>
                    </div>
