...
class CreateConcealedLight extends Component { 
    ...
    onSubmit(e) {
        ...
        const exercise = {
            ...
            productRupees:this.state.this.productRupees,
        ...
        axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/cl/add', exercise).then(res=>{this.setState({message:res})})
            this.setState({ 
                productProductCode:"",
                productModel:"",
                productWatt:"",
    ...
    render() { 
        return (
            ...
            <div className="admin-form-container">
                <div className='Title-homepage'>Add a Concealed Light Product</div>
...
export default CreateConcealedLight;