    ...
    <div className='Listproducts'>
      <div className='productfilter'>
        <div className='Sorter' style={{'display':'flex'}}>
            ...
            <div id='filteroperner' style={{'display':'none'}}><div style={{'color':'rgb(246, 155, 10)','borderBottom':'2px solid rgb(246, 155, 10)'}}><div className='same1 tags-details'>BY A TO Z</div></div>
            <div style={{'color':'rgb(246, 155, 10)','borderBottom':'2px solid rgb(246, 155, 10)'}}><div className='same1 tags-details'>BY Z TO A</div></div>
            <div style={{'color':'rgb(246, 155, 10)','borderBottom':'2px solid rgb(246, 155, 10)'}}><div className='same1 tags-details'>BY PRICE</div></div>
            <div style={{'color':'rgb(246, 155, 10)','borderBottom':'2px solid rgb(246, 155, 10)'}}><div className='same1 tags-details'>BY MOST POPULAR</div></div>
            <div style={{'color':'rgb(246, 155, 10)','borderBottom':'2px solid rgb(246, 155, 10)'}}><div className='same1 tags-details'>BY LATEST</div>
            </div>
        ...
        <div className='Sorter' style={{'display':'flex'}}>
            ...
            {this.props.category.map(element=>{
              return   <div style={{'color':'rgb(246, 155, 10)','borderBottom':'2px solid rgb(246, 155, 10)'}}><div className='same1 tags-details'>{element}</div></div>
            })}
...
class WLlist extends Component {
  ...
  constructor(props) {
    ...
    bgsList() {
      if(sessionStorage.sl != null)
        {
        var obj = JSON.parse(sessionStorage.sl)
        console.log(obj);
