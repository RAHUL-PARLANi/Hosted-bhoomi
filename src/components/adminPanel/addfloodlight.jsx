...
class CreateFloodLight extends Component { 
    ...
    onSubmit(e) {
        ...
        axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/fl/add', exercise).then(res=>{this.setState({message:res})})
            this.setState({ 
           productModelNo:"",
           productWatt:"",
           productWeight:"",
    ...
    render() { 
        return (
            ...
            <div className="admin-form-container">
                <div className='Title-homepage'>Add a Flood Light Product</div>
...
export default CreateFloodLight;