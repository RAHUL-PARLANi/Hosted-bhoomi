...
function wtp(){
    axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/wl/WTP/'+window.location.pathname.split('/').pop()).then(
        alert('Liked')
    )
...
function invite(){
    window.open(
        "whatsapp://send?text=Hi, Checkout this amazing Wall Light by Bhoomi " + window.location.href,
...
const WLinfo = () => {
    ...
    useEffect(() => {
        axios.get('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/wl/'+window.location.pathname.split('/').pop())
                    .then(res => {
        ...
        >ADD TO CART</button> <div className='button-icons-like' onClick={wtp}><FontAwesomeIcon icon="fa-solid fa-heart" /></div><div className='button-icons' onClick={()=>{invite()}}><FontAwesomeIcon icon="fa-solid fa-share-nodes" /></div></div>
                    ...
                    <div className='discription'>
                        ...
                        <div className='Information-tag'>Details</div>
                            ...
                            <div className='point-2'><div className='labels'> Colour Available</div><div className='label-content'>{data.productColourAvailable}</div></div>
