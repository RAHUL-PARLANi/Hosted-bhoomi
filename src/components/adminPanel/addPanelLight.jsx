...
class CreatePanelLight extends Component { 
    ...
    onSubmit(e) {
        ...
        axios.post('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/pl/add', exercise).then(res=>{this.setState({message:res})})
            this.setState({ 
                productProductCode:"",
                productType:"",
                productWatt:"",
    ...
    render() { 
        return (
            ...
            <div className="admin-form-container">
                <div className='Title-homepage'>Add a Paneled Light Product</div>
...
export default CreatePanelLight;