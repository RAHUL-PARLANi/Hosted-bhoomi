...
const BoardGame = (props) => (
    <tr>
        ...
        <td className="text-xs font-weight-bold">{props.bg.Email}</td>
...
class ShowFeedbacks extends Component {
  ...
  componentDidMount(){
    axios.get('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/feedback/')
                .then(res => {
...
deleteBGS(id) {
            axios.delete('https://bejewelled-kleicha-3163f4.netlify.app/.netlify/functions/api/feedback/' +id)
  ...
  <div className='Title-homepage-Table'>Feedbacks</div>
         <div class="table-responsive">
       <table id="table" className="table align-items-center justify-content-center mb-0">
           <thead>
              <tr>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">ACTIONS:</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Feedbacker Email :</th>
               <th className="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Feedbacker Number :</th>
